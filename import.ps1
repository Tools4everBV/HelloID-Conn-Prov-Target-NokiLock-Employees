###################################################
# HelloID-Conn-Prov-Target-NokiLock-Employees-Import
# PowerShell V2
###################################################
...
try {
    ...
    $ex = $PSItem
    $auditMessage = "Could not import NokiLock-Employees accounts. Error: $($_.Exception.Message)"
