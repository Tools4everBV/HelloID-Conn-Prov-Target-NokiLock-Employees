##################################################
# HelloID-Conn-Prov-Target-NokiLock-Employee-Create
# PowerShell V2
##################################################
...
try {
    ...
    switch ($action) {
        'CreateAccount' {
            ...
            if (-not($actionContext.DryRun -eq $true)) {
                Write-Information 'Creating and correlating NokiLock-Employee account'
                ...
                Write-Information '[DryRun] Create and correlate NokiLock-Employee account, will be executed during enforcement'
            }
        ...
        'CorrelateAccount' {
            Write-Information 'Correlating NokiLock-Employee account'
    ...
    $ex = $PSItem
    $auditMessage = "Could not create or correlate NokiLock-Employee account. Error: $($ex.Exception.Message)"
